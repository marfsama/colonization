...
//                bVar1 = true;
     ...
     * @param bitmask bitmask of bits to change
     * @param set_or_remove when true, the bits are set. when false, the bits are cleared
     */
    public static void FUN_1373_0162_change_surface_type_at(int x, int y, int bitmask, boolean set_or_remove) {
